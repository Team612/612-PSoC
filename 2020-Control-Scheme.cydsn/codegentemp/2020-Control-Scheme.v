...
module top ;
	...
	wire [0:0] tmpOE__Internal_LED_net;
	wire [0:0] tmpFB_0__Internal_LED_net;
	wire [0:0] tmpIO_0__Internal_LED_net;
	wire [0:0] tmpINTERRUPT_0__Internal_LED_net;
	electrical [0:0] tmpSIOVREF__Internal_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Internal_LED
		 (.oe(tmpOE__Internal_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Internal_LED_net[0:0]}),
		  .io({tmpIO_0__Internal_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Internal_LED_net),
		  .interrupt({tmpINTERRUPT_0__Internal_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Internal_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Buttons_9_11.SignalWidth = 2;
	...
	wire [1:0] tmpOE__Pin_9_11_net;
	wire [1:0] tmpIO_1__Pin_9_11_net;
	...
	assign tmpOE__Pin_9_11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
    ...
    defparam Status_9_11.NumInputs = 2;

	wire [0:0] tmpOE__LED_15_0_net;
	wire [0:0] tmpFB_0__LED_15_0_net;
	wire [0:0] tmpIO_0__LED_15_0_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_0_net;
	electrical [0:0] tmpSIOVREF__LED_15_0_net;

	cy_psoc3_pins_v1_10
		#(.id("39389bc7-4d01-46e4-9cf0-28cc4dcf73d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_0
		 (.oe(tmpOE__LED_15_0_net),
		  .y({Net_266}),
		  .fb({tmpFB_0__LED_15_0_net[0:0]}),
		  .io({tmpIO_0__LED_15_0_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_0_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 LEDs_1_8 (
        .control_1(Net_263),
        .control_2(Net_264),
        .control_3(Net_273),
        .control_0(Net_262),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LEDs_1_8.Bit0Mode = 0;
    defparam LEDs_1_8.Bit1Mode = 0;
    defparam LEDs_1_8.Bit2Mode = 0;
    defparam LEDs_1_8.Bit3Mode = 0;
    defparam LEDs_1_8.Bit4Mode = 0;
    defparam LEDs_1_8.Bit5Mode = 0;
    defparam LEDs_1_8.Bit6Mode = 0;
    defparam LEDs_1_8.Bit7Mode = 0;
    defparam LEDs_1_8.BitValue = 0;
    defparam LEDs_1_8.BusDisplay = 0;
    defparam LEDs_1_8.ExtrReset = 0;
    defparam LEDs_1_8.NumOutputs = 8;

	wire [0:0] tmpOE__LED_15_1_net;
	wire [0:0] tmpFB_0__LED_15_1_net;
	wire [0:0] tmpIO_0__LED_15_1_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_1_net;
	electrical [0:0] tmpSIOVREF__LED_15_1_net;

	cy_psoc3_pins_v1_10
		#(.id("07bc89bf-6c21-4a38-b858-13a8b7797a8f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_1
		 (.oe(tmpOE__LED_15_1_net),
		  .y({Net_267}),
		  .fb({tmpFB_0__LED_15_1_net[0:0]}),
		  .io({tmpIO_0__LED_15_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_1_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_15_2_net;
	wire [0:0] tmpFB_0__LED_15_2_net;
	wire [0:0] tmpIO_0__LED_15_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_2_net;
	electrical [0:0] tmpSIOVREF__LED_15_2_net;

	cy_psoc3_pins_v1_10
		#(.id("286a92c7-2827-49a2-a01d-2636dd7a6295"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_2
		 (.oe(tmpOE__LED_15_2_net),
		  .y({Net_268}),
		  .fb({tmpFB_0__LED_15_2_net[0:0]}),
		  .io({tmpIO_0__LED_15_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_15_3_net;
	wire [0:0] tmpFB_0__LED_15_3_net;
	wire [0:0] tmpIO_0__LED_15_3_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_3_net;
	electrical [0:0] tmpSIOVREF__LED_15_3_net;

	cy_psoc3_pins_v1_10
		#(.id("afe20f99-b373-4fa1-ba30-2fa7312ea357"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_3
		 (.oe(tmpOE__LED_15_3_net),
		  .y({Net_269}),
		  .fb({tmpFB_0__LED_15_3_net[0:0]}),
		  .io({tmpIO_0__LED_15_3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_3_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_15_4_net;
	wire [0:0] tmpFB_0__LED_15_4_net;
	wire [0:0] tmpIO_0__LED_15_4_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_4_net;
	electrical [0:0] tmpSIOVREF__LED_15_4_net;

	cy_psoc3_pins_v1_10
		#(.id("4c6df25b-cfaa-4cfc-adcd-dc1e8c00172b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_4
		 (.oe(tmpOE__LED_15_4_net),
		  .y({Net_270}),
		  .fb({tmpFB_0__LED_15_4_net[0:0]}),
		  .io({tmpIO_0__LED_15_4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_4_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_15_5_net;
	wire [0:0] tmpFB_0__LED_15_5_net;
	wire [0:0] tmpIO_0__LED_15_5_net;
	wire [0:0] tmpINTERRUPT_0__LED_15_5_net;
	electrical [0:0] tmpSIOVREF__LED_15_5_net;

	cy_psoc3_pins_v1_10
		#(.id("5f6b1a35-3bc3-41d5-8207-43825c8b99cd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_15_5
		 (.oe(tmpOE__LED_15_5_net),
		  .y({Net_271}),
		  .fb({tmpFB_0__LED_15_5_net[0:0]}),
		  .io({tmpIO_0__LED_15_5_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_15_5_net),
		  .interrupt({tmpINTERRUPT_0__LED_15_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_15_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_12_2_net;
	wire [0:0] tmpFB_0__LED_12_2_net;
	wire [0:0] tmpIO_0__LED_12_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_12_2_net;
	electrical [0:0] tmpSIOVREF__LED_12_2_net;

	cy_psoc3_pins_v1_10
		#(.id("def00cdf-b8d5-4328-89e3-555e9c42a64a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_12_2
		 (.oe(tmpOE__LED_12_2_net),
		  .y({Net_262}),
		  .fb({tmpFB_0__LED_12_2_net[0:0]}),
		  .io({tmpIO_0__LED_12_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_12_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_12_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_12_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_12_3_net;
	wire [0:0] tmpFB_0__LED_12_3_net;
	wire [0:0] tmpIO_0__LED_12_3_net;
	wire [0:0] tmpINTERRUPT_0__LED_12_3_net;
	electrical [0:0] tmpSIOVREF__LED_12_3_net;

	cy_psoc3_pins_v1_10
		#(.id("24936d5a-00bf-434f-a072-a6329920c1e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_12_3
		 (.oe(tmpOE__LED_12_3_net),
		  .y({Net_263}),
		  .fb({tmpFB_0__LED_12_3_net[0:0]}),
		  .io({tmpIO_0__LED_12_3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_12_3_net),
		  .interrupt({tmpINTERRUPT_0__LED_12_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_12_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 LEDs_9_10 (
        .control_1(Net_271),
        .control_2(Net_256),
        .control_3(Net_257),
        .control_0(Net_270),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LEDs_9_10.Bit0Mode = 0;
    defparam LEDs_9_10.Bit1Mode = 0;
    defparam LEDs_9_10.Bit2Mode = 0;
    defparam LEDs_9_10.Bit3Mode = 0;
    defparam LEDs_9_10.Bit4Mode = 0;
    defparam LEDs_9_10.Bit5Mode = 0;
    defparam LEDs_9_10.Bit6Mode = 0;
    defparam LEDs_9_10.Bit7Mode = 0;
    defparam LEDs_9_10.BitValue = 0;
    defparam LEDs_9_10.BusDisplay = 0;
    defparam LEDs_9_10.ExtrReset = 0;
    defparam LEDs_9_10.NumOutputs = 2;

	wire [0:0] tmpOE__LED_12_4_net;
	wire [0:0] tmpFB_0__LED_12_4_net;
	wire [0:0] tmpIO_0__LED_12_4_net;
	wire [0:0] tmpINTERRUPT_0__LED_12_4_net;
	electrical [0:0] tmpSIOVREF__LED_12_4_net;

	cy_psoc3_pins_v1_10
		#(.id("3c905d8d-8fcc-4e48-aa4c-47725d294b6c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_12_4
		 (.oe(tmpOE__LED_12_4_net),
		  .y({Net_264}),
		  .fb({tmpFB_0__LED_12_4_net[0:0]}),
		  .io({tmpIO_0__LED_12_4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_12_4_net),
		  .interrupt({tmpINTERRUPT_0__LED_12_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_12_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_12_5_net;
	wire [0:0] tmpFB_0__LED_12_5_net;
	wire [0:0] tmpIO_0__LED_12_5_net;
	wire [0:0] tmpINTERRUPT_0__LED_12_5_net;
	electrical [0:0] tmpSIOVREF__LED_12_5_net;

	cy_psoc3_pins_v1_10
		#(.id("9d891cd9-ea22-4264-8e55-828e55097d49"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_12_5
		 (.oe(tmpOE__LED_12_5_net),
		  .y({Net_273}),
		  .fb({tmpFB_0__LED_12_5_net[0:0]}),
		  .io({tmpIO_0__LED_12_5_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_12_5_net),
		  .interrupt({tmpINTERRUPT_0__LED_12_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_12_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
